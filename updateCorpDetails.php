...
$sql = "SELECT * FROM corp_details WHERE id='$corp_id' ";
    ...
    <div class="row">
      ...
      <div class="col-xl-10" style="margin-top: 115px;min-height: 1000px;">
        <div class="card bg-secondary shadow">
          ...
          <div class="card-body">
            <form method="post" action="updateCorpScript.php"onsubmit="return deleteAlert();">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group"style="margin-bottom:7px;">
                      ...
                      <input type="text" class="form-control form-control-alternative" style="text-transform: uppercase;" placeholder="Enter Reference" name="reference" id="reference" list="refList" value="<?php echo $row['reference'] ?>">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group" style="margin-bottom:7px;">
                      ...
                      <input type="text" name="company_name" class="form-control form-control-alternative" style="text-transform: uppercase;" placeholder="Enter company Name"  value="<?php echo $row['company_name'] ?>">
                    </div>
                  </div>
                </div>
                <?php $c_address = $row['c_address'] ;?>
                <div class="row">
                  <div class="col-lg-6">
                      <div class="form-group" style="margin-bottom:7px;">
                        <label class="form-control-label" for="c_address">Address</label>
                        <textarea type="text" rows="4" style="text-transform: uppercase;"name="c_address" class="form-control form-control-alternative" placeholder="Enter Address"><?php echo $c_address; ?></textarea>
                      </div>
                    </div>
                </div>
