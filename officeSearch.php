...
$sql = "SELECT o_invoice, invoice_id, total_amount FROM oinvoice_details ORDER BY o_invoice";
				...
				<div class="row">
					...
					<div class="form-inline">
			            <select id="searchby" class="form-control form-control-sm ml-3 w-85" style="color: #32325d">
			              <option value="0">Office Invoice No
			              </option>
			              <option value="1">Invoice No
			              </option>
			            </select>
			        </div>
				...
				<div class="table-responsive">
					<table id="myTable"class="table align-items-center table-dark table-flush">
						<thead class="thead-dark">
							<tr>
								<th style="color: white; font-weight:bold;"scope="col"onclick="sortTable(0)">Office Invoice No</th>
								<th style="color: white; font-weight:bold;"scope="col">Invoice No</th>
								<th style="color: white; font-weight:bold;"scope="col">Total Amount</th>
								...
								{ ?>    
									<tr>
										...
										<td>
											...
											<?php 
													$sql1 = "SELECT o_invoice FROM oinvoice_details where invoice_id= '$t' ";
